...
Проект представляет собой систему автономной посадки БПЛА на провода ЛЭП, используя лидар и тепловизор для точного позиционирования <br> Решение включает расчёт маршрута полёта и веб-интерфейс для управления. Это автоматизирует мониторинг и обслуживание ЛЭП, обеспечивая безопасное приземление дрона на провод и возвращение в точку взлёта 
