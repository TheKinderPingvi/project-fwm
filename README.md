...
Целью проекта является разработка системы автономной посадки БПЛА на провода ЛЭП, автоматизирующей мониторинг и обслуживание линий электропередач, обеспечивая безопасное приземление дрона на провод и возвращение в точку взлёта <br> Ожидаемый продуктовый результат - система Fly Without Me, решение которой включает в себя использование лидара и тепловизора для точного позиционирования, а также расчёт маршрута полёта и веб-интерфейс для управления
